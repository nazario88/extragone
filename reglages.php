...
/* SEO
——————————————————————————————————————————————————*/
$title = "Réglages du compte — eXtragone";
$description = "Gère ton profil et tes préférences sur eXtragone.";
$url_canon = 'https://www.extrag.one/reglages';
...
<div class="w-full max-w-4xl mx-auto px-5 py-8">
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-lg">
            ...
            <form method="post" action="includes/profil/endpoints/update-profile.php" enctype="multipart/form-data" id="profileForm">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-6">
                        <img src="<?= $user['avatar'] ?: 'https://www.extrag.one/uploads/avatars/' . urlencode($user['display_name']) ?>" 
                             id="avatar-preview"
                             alt="Avatar"
                             class="w-24 h-24 rounded-full object-cover ring-4 ring-slate-300/70 dark:ring-white/10 shadow-lg">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-lg">
            ...
            <form method="post" action="includes/profil/endpoints/update-notifications.php" id="notifForm">
                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-lg">
            ...
            <form method="post" action="includes/profil/endpoints/change-password.php" id="passwordForm">
                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
