        ...
        <div class="container mx-auto flex flex-wrap items-center justify-between">
            ...
            <div class="w-full md:w-1/2 md:text-center md:mb-0 mb-8">
                <ul class="list-reset flex justify-center flex-wrap text-xs gap-3">
                    <li class="hidden md:block"><a class="hover:text-blue-500 transition-colors duration-300" href="https://www.extrag.one/contact" rel="nofollow">Contact</a></li>
                    &#151;
    ...
    <!-- Fonctions -->    
    <script type="text/javascript" src="https://www.extrag.one/assets/js/fonctions.js"></script>
</body>
</html>
