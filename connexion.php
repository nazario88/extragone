...
if (isLoggedIn()) {
    ...
    if ($redirect) {
        // Gérer les redirections vers les différents domaines
...
$title = "Connexion / Inscription — eXtragone";
$description = "Connecte-toi pour accéder à toutes les fonctionnalités de l'écosystème eXtragone : avis sur les outils, soumission de projets, et plus encore.";
$url_canon = 'https://www.extrag.one/connexion';
...
<div class="w-full max-w-4xl mx-auto px-5 py-12">
    ...
    <div class="text-center mb-8">
        <h1 class="px-4 m-2 mx-auto text-xl md:text-4xl text-center font-bold tracking-tight dark:text-slate-500">
            Rejoins la <span class="dark:text-white font-semibold">communauté</span> !
        </h1>
        <p class="text-gray-600 dark:text-gray-300">
            Un seul compte pour tout l'écosystème eXtragone
        </p>
    </div>
    ...
    <div class="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-800">
        ...
        <ul class="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <li><i class="fa-solid fa-check text-green-500 mr-2"></i>Laisser des avis détaillés sur les outils</li>
